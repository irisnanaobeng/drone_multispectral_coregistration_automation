...
This analysis demonstrates the coregistration of DJI multispectral bands (Green, Red, NIR) using a simple shift-based method to maximize correlation with the reference Red band. The visualizations before and after alignment clearly show improved spatial correspondence, especially in high-variance regions, confirming successful coregistration.
